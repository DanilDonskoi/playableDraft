class ShieldIcon {
    ...
    onResize( { leftUI, rightUI, upUI, downUI, orientation} ) {
        if ( orientation === 'portraite' ) {
			...
			this.handOptionTutor.position.set( leftUI + 100, downUI - 845);
        } 
        ...
        if ( orientation === 'landscape' ) {
			...
			this.handOptionTutor.position.set( leftUI + 370, upUI + 150 );
        }
    }
	...
	initOptionTutor() {
		...
		this.timelineOption.to( handSprite, 0.5, {x: 200, y: 320, ease: 'sine.out'});
        this.timelineOption.to( handSprite.scale, 0.3, {x: 0.95, y: 0.95, repeat: 1, yoyo: true, ease: 'sine.inOut' });	
		this.timelineOption.to( handSprite, 0.5, {x: 540, y: 430, ease: 'sine.out'});
        this.timelineOption.to( handSprite.scale, 0.3, {x: 0.95, y: 0.95, repeat: 1, yoyo: true, ease: 'sine.inOut' });	
